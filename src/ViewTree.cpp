...
void ViewTree::PushLevel(int nodes, std::string robot_name){
  if(nodes>0){
...
void ViewTree::UpdateSelectionPath( std::vector<int> path ){
...
int ViewTree::GetLevel(){
  return level_nodes.size();
}

void ViewTree::DrawGL(){
...
void ViewTree::DrawNode( double x, double y, double radius, int number)
{
...
void ViewTree::DrawLineFromNodeToNode(double x1, double y1, double n1, double x2, double y2, double n2){
