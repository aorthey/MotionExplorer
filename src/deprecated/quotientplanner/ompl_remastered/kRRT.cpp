...
ompl::base::PlannerStatus ompl::control::kRRT::solve(const base::PlannerTerminationCondition &ptc)
{
    ...
    while (ptc == false)
    {
        ...
        //std::static_pointer_cast<oc::SpaceInformation>(si_)->printControl(nmotion->control, std::cout);
        unsigned int cd = controlSampler_->sampleTo(rctrl, nmotion->control, nmotion->state, rmotion->state);
        //std::static_pointer_cast<oc::SpaceInformation>(si_)->printControl(rctrl, std::cout);
