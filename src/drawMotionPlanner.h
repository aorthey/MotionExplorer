...
namespace GLDraw {
  ...
  void drawPathSweptVolume(Robot *robot, std::vector<std::vector<Matrix4> > mats, vector<GLDraw::GeometryAppearance> appearanceStack, double sweptvolumeScale = 0.98, GLColor sweptvolumeColor = GLColor(0.7,0.0,0.9,0.2));
