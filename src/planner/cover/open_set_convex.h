...
typedef Nef_polyhedron::Halffacet_const_iterator                  Nef_halffacet_const_iterator;
typedef Nef_polyhedron::Halffacet_cycle_const_iterator            Nef_halffacet_cycle_const_iterator;
typedef Nef_polyhedron::Volume_const_iterator                     Nef_volume_const_iterator;
...
namespace cover{
  class OpenSetConvex: public OpenSet{
    public:
      ...
      void DrawGLPolyhedron(GUIState& state, const Nef_polyhedron &poly_);
      void DrawGLPolyhedron(GUIState& state, const Polyhedron_3 &poly_);
    ...
    protected:
      ...
      Nef_polyhedron free_workspace;
      std::vector<Polyhedron_3> free_workspace_convex_parts;
