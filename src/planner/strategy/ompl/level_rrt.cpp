...
LevelRRT::LevelRRT(const base::SpaceInformationPtr &si, const base::SpaceInformationPtr &si2): RRT(si), si_level2(si2)
{
  setName("LevelRRT");
}
LevelRRT::~LevelRRT(void)
{
}
ob::PlannerStatus LevelRRT::solve(const ob::PlannerTerminationCondition &ptc)
{
    //setRange(0.1);
...
void LevelRRT::getPlannerData(base::PlannerData &data) const
{
