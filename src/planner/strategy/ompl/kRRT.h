...
namespace ompl
{
    namespace control
    {
        /**
           ...
           kRRT is a tree-based motion planner that uses the following
           idea: kRRT samples a random state @b qr in the state space,
           ...
           [[more]](http://msl.cs.uiuc.edu/~lavalle/kRRTpubs.html)
        */

        /** \brief Rapidly-exploring Random Tree */
        class kRRT : public base::Planner
        {
        public:
            /** \brief Constructor */
            kRRT(const SpaceInformationPtr &si);
