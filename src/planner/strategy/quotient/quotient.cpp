...
const StateSpacePtr Quotient::ComputeQuotientSpace(const StateSpacePtr Q1, const StateSpacePtr Q0)
{
  ...
  switch (type) {
    ...
    case SE2RN_SE2: case SE3RN_SE3: case SO2RN_SO2:
      {
    ...
    case SE2RN_R2:
      {
        ...
        ob::StateSpacePtr SO2(new ob::SO2StateSpaceFullInterpolate());
        ...
        if(Q1_decomposed.at(0)->getType() == base::STATE_SPACE_SE3
          ...
          if(Q1_decomposed.at(0)->getType() == base::STATE_SPACE_SE2
            ...
            ///##############################################################################/
              ...
              std::cout << "Cannot project onto " << Q0->getType() << std::endl;
              exit(0);
            }
          }else{
...
void Quotient::MergeStates(const ob::State *qQ0, const ob::State *qX1, ob::State *qQ1) const
{
  ...
  switch (type) {
    ...
    case SO2RN_SO2:
      {
        ob::SO2StateSpaceFullInterpolate::StateType *sQ1_SO2 = qQ1->as<ob::CompoundState>()->as<SO2StateSpaceFullInterpolate::StateType>(0);
        ob::RealVectorStateSpace::StateType *sQ1_RN = qQ1->as<ob::CompoundState>()->as<RealVectorStateSpace::StateType>(1);

        const ob::SO2StateSpaceFullInterpolate::StateType *sQ0 = qQ0->as<SO2StateSpaceFullInterpolate::StateType>();
        const ob::RealVectorStateSpace::StateType *sX1 = qX1->as<RealVectorStateSpace::StateType>();
    ...
    case SE2RN_R2:
      {
        ...
        const ob::RealVectorStateSpace::StateType *sQ0 = qQ0->as<RealVectorStateSpace::StateType>();
        const ob::SO2StateSpaceFullInterpolate::StateType *sX1_SO2 = qX1->as<ob::CompoundState>()->as<ob::SO2StateSpaceFullInterpolate::StateType>(0);
        const ob::RealVectorStateSpace::StateType *sX1_RN = qX1->as<ob::CompoundState>()->as<RealVectorStateSpace::StateType>(1);
    ...
    case SE2RN_R2:
      {
        ...
        ob::SO2StateSpaceFullInterpolate::StateType *sX1_SO2 = qX1->as<ob::CompoundState>()->as<ob::SO2StateSpaceFullInterpolate::StateType>(0);
        ob::RealVectorStateSpace::StateType *sX1_RN = qX1->as<ob::CompoundState>()->as<RealVectorStateSpace::StateType>(1);
...
void Quotient::ProjectQ0Subspace( const ob::State* q, ob::State* qQ0 ) const
{
  ...
  switch(type){
    ...
    case SE2RN_R2:
      {
        const ob::SE2StateSpaceFullInterpolate::StateType *sQ1 = q->as<ob::CompoundState>()->as<SE2StateSpaceFullInterpolate::StateType>(0);
        ob::RealVectorStateSpace::StateType *sQ0 = qQ0->as<RealVectorStateSpace::StateType>();
        sQ0->values[0] = sQ1->getX();
        sQ0->values[1] = sQ1->getY();
        break;
    ...
    case SO2RN_SO2:
      {
        const ob::SO2StateSpaceFullInterpolate::StateType *sQ1_SO2 = q->as<ob::CompoundState>()->as<SO2StateSpaceFullInterpolate::StateType>(0);
        ob::SO2StateSpaceFullInterpolate::StateType *sQ0_SO2 = qQ0->as<SO2StateSpaceFullInterpolate::StateType>();
...
void Quotient::Print(std::ostream& out) const
{
  ...
  if(parent == nullptr){
    ...
    switch (type) {
      ...
      case Quotient::SO2RN_SO2:
        {
          out << "SO(2) | Q" << level+1 << ": SO(2)xR^" << X1_dimension << " | X" << level+1 << ": R^" << X1_dimension;
          break;
        }
