...
class FixedContactConstraint3D : public ob::Constraint
{
protected:
    std::vector<Triangle3D> tris;

public:
    FixedContactConstraint3D(GeometricCSpaceContact3D *cspace, int ambientSpaceDim, Robot *robot, RobotWorld *world, int linkNumber, std::string meshFrom);
