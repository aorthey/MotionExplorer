#include "planner/cspace/cspace_geometric_SE3RN.h"

GeometricCSpaceOMPLSE3RN::GeometricCSpaceOMPLSE3RN(RobotWorld *world_, int robot_idx):
  CSpaceOMPL(world_, robot_idx)
{
}
bool GeometricCSpaceOMPLSE3RN::isDynamic() const
{
  return false;
}

void GeometricCSpaceOMPLSE3RN::initSpace()
{
  //###########################################################################
...
void GeometricCSpaceOMPLSE3RN::print(std::ostream& out) const
{
...
void GeometricCSpaceOMPLSE3RN::ConfigToOMPLState(const Config &q, ob::State *qompl)
{
...
Config GeometricCSpaceOMPLSE3RN::OMPLStateToConfig(const ob::SE3StateSpace::StateType *qomplSE3, const ob::RealVectorStateSpace::StateType *qomplRnState){
...
Config GeometricCSpaceOMPLSE3RN::OMPLStateToConfig(const ob::State *qompl){
  if(Nompl>0){
