...
robot_name = 'Lshape/PlanarLshape'
...
CreateCylinderRobot(robot_name + "_cylinder_inner", thickness/2, 2.0*thickness_Z, 1.57)
CreateCylinderRobot(robot_name + "_cylinder_outer", d, thickness_Z/2.0, 1.57)
CreateCylinderRobot(robot_name + "_point_inner", 0.01, 2.0*thickness_Z, 1.57)
