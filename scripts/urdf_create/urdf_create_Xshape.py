...
CreateSphereRobot(robot_name + "_sphere_inner", t1/2)
...
CreateCylinderRobot(robot_name + "_capsule_inner", t1/2, L1)

CreateCylinderRobot(robot_name + "_capsule_outer", L1+t1/2, L1)
