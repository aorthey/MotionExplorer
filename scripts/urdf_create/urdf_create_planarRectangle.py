...
robot_name = 'planar/PlanarRectangle'
...
CreateCylinderRobot(robot_name + "_cylinder_inner", d_inner, 2.0*height, 1.57)
CreateCylinderRobot(robot_name + "_cylinder_outer", d_outer, height/2.0, 1.57)
