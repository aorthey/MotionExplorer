...
#CreateCylinderRobot(folder, robot_name + "_capsule_inner", thicknessx/2, thicknessz)
#CreateCylinderRobot(folder, robot_name + "_capsule_outer", L1+thicknessx/2, thicknessz)
