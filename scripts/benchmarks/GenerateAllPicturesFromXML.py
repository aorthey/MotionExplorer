...
PlotTimeVsDimension(fname, show=True, START_AT_BEGINNING=True, EXTRAPOLATED_PTS=0)
...
# PlotTimeVsDimension(fname, START_AT_BEGINNING=False, EXTRAPOLATED_PTS=0, REMOVE_PTS_START=2)
