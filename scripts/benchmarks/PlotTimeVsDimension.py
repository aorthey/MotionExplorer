...
def PlotTimeVsDimensionBreakPlot(fname, suffix="", show=False, START_AT_BEGINNING=False, REMOVE_PTS_START = 0, REMOVE_PTS_END = 0):
  benchmark = BenchmarkAnalytica(fname)
  ...
  #### EXTRAPOLATED FUNCTIONS
  ax.fill_between(I, times_min, times_max, facecolor='0.9')
  ax2.fill_between(I, times_min, times_max, facecolor='0.9')
