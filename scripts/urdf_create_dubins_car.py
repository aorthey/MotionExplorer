...
CreateCylinderRobot(folder, robot_name + "_capsule_inner", 0.5*width, height)
CreateCylinderRobot(folder, robot_name + "_capsule_outer", width, height)
