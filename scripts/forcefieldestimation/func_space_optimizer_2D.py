...
X_test = np.array(zip(xx.flatten(),yy.flatten())).T
...
plt.quiver(X_test[0,:],X_test[1,:],Y_estimate[0,:],Y_estimate[1,:], color='black',
    label="Estimated")

plt.quiver(X_test[0,:],X_test[1,:],Y_truth[0,:],Y_truth[1,:], color='grey',
    label="Ground Truth")

plt.plot(X_random_walk[0,:],X_random_walk[1,:],'-ko',ms=1)

plt.quiver(X_random_walk[0,:],X_random_walk[1,:],Y_random_walk[0,:],Y_random_walk[1,:],
